...
1. Спроектируйте структуру витрины расчётов с курьерами
...
2. Спроектируйте структуру DDS-слоя
...
3. Спроектируйте структуру STG-слоя.
